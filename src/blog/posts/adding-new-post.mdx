...
To write a new blog post, create a markdown (or MDX) file inside the `src/blog/posts/` directory.

You can organize posts into subdirectories to make content easier to manage. The subdirectory name becomes part of the post URL. For example, `src/blog/posts/2025/example-post.md` will be available at `/posts/2025/example-post`.
...
src/blog/posts/very-first-post.md          -> mysite.com/posts/very-first-post
src/blog/posts/2025/example-post.md        -> mysite.com/posts/2025/example-post
src/blog/posts/_2026/another-post.md       -> mysite.com/posts/another-post
src/blog/posts/docs/_legacy/how-to.md      -> mysite.com/posts/docs/how-to
src/blog/posts/Example Dir/Dummy Post.md   -> mysite.com/posts/example-dir/dummy-post
```
...
```yaml file="src/blog/posts/sample-post.md"
---
